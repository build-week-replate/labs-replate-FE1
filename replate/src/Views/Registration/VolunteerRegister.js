...
class VolunteerReg extends React.Component {
    ...
    return (
        ...
        <VolRegForm>
            ...
            <p>Would you like to register as a Business Instead?<br />
            <Link to='/business-registration'>Register as a Business</Link>
            </p>
        <form onSubmit={this.volunteerRegistration}>
        <input
                type='text'
                name='name'
